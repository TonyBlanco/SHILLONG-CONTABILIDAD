...
# BANCO
# ============================================================
# BANCO + ESTADO — CHIP STYLE MODERNO EN UNA SOLA LÍNEA
# ============================================================
fila_banco_estado = QHBoxLayout()
fila_banco_estado.setSpacing(20)

# ============================================================
# BANCO (Caja, Federal Bank, SBI…)
# ============================================================
self.banco_buttons = QButtonGroup(self)
self.banco_buttons.setExclusive(True)

layout_banco = QHBoxLayout()
layout_banco.setSpacing(8)
...
for texto in ["Caja", "Federal Bank", "SBI", "Union Bank", "Otro"]:
    ...
    layout_banco.addWidget(rb)
    if texto == "Caja":
        rb.setChecked(True)

fila_banco_estado.addLayout(layout_banco)
...
for texto in ["Pagado", "Pendiente"]:
    ...
    layout_estado.addWidget(rb)
    if texto == "Pagado":
        rb.setChecked(True)

fila_banco_estado.addLayout(layout_estado)
fila_banco_estado.addStretch()

# AGREGAR AL FORMULARIO COMO UNA SOLA FILA
form.addRow("Banco / Estado:", fila_banco_estado)
